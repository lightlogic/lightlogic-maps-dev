...
module.exports = {
  getBFScommuneData: function (bfsCommuneName, callback) {
    // COMMUNE_TYPE_URI = "http://www.geonames.org/ontology#A.ADM3";
    // COMMUNE_DOMAIN_LABEL = "bfsNum";
    ...
    request
      ...
      .end((err, res) => {
        if (err) {
          ...
          // const communeRes = new GeoEntity({
          //   uri: res.body.results.bindings[0].communeUri.value,
          //   domainId: res.body.results.bindings[0].bfsNum.value,
          //   domainIdLabel: COMMUNE_DOMAIN_LABEL,
          //   isA: COMMUNE_TYPE_URI,
          //   description: res.body.results.bindings[0].communeName.value,
