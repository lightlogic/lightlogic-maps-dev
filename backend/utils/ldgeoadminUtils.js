...
module.exports = {
  getBFScommuneData: function (bfsCommuneName, callback) {
    ...
    const communeQuery = SPARQLQUERY_TEMPLATE.replace("COMMUNEPLACEHOLDER",bfsCommuneName);
    request
